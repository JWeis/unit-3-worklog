...
class GetTask:
    def __init__(self):
        ...
        Creates a data varible which is created from opening the provided CSV file in read only mode.
    ...
    def available_dates(self):
        ...
        Adds all Dates to the output list variable if that date is not already in the list.
    ...
    def by_date(self, date):
        """ Gets all work logs that have been added to the work log on a given date
    ...
    def av_times(self):
        ...
        Adds all times to the output list variable if that time is not already in the list.
    ...
    def by_time_spent(self, time_spent):
        """ Gets all work logs that have been added to the work log on with a given time spent amount
    ...
    def exact_match(self, string):
        """ Gets all work logs that have been added to the work log that match a given search query
    ...
    def pattern_match(self, pattern):
        """ Gets all work logs that have been added to the work log that match a given regex pattern
