...
class Task:
    def __init__(self):
        ...
        Sets fieldnames and set up the DictWriter. writeheader() commented out to not write new header row
        for each new object. 
        """
    ...
    def new_task(self, task_name, task_notes, time_spent):
        ...
        Writes a new row in the provided CSV with fieldnames that were initiated
        """
